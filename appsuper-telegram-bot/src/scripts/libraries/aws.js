...
// DEFINE FUNCTIONS ####################################################################################################
   ...
   function setAwsCredentialsFromObject(AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY, AWS_REGION){ // ==================================
...
// #####################################################################################################################
   ...
   async function appendTextToFile(s3, bucket, file, contentToAdd){ // =================================================
      ...
      if (!fileExist){
         await createFile(s3, bucket, file)
...
// #####################################################################################################################
   ...
   async function createFolder(s3, bucket, foldername){ // =============================================================
      ...
      const folderCreated = await s3.putObject(params, function (err, data) {
